...
function (_Component) {
  function Sticky() {
    ...
    return (_temp = _this = _Component.call.apply(_Component, [this].concat(args)) || this, _defineProperty(_defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      isSticky: false,
      window: {
        height: window.innerHeight,
        width: window.innerWidth
      }
    }), "StickyRef", _react.default.createRef()), _temp) || _assertThisInitialized(_this);
  }
