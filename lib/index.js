...
function (_Component) {
  ...
  _proto.ifSticky = function ifSticky(ok, faild) {
    ...
    var stateSticky = this.state.isSticky !== undefined ? this.state.isSticky : true;

    if (edge != "top") {
      if (winData.scrollTop + winData.height < nodeData.offsetTop + nodeData.height + triggerDistance && stateSticky) {
        return ok.call(self);
      }
    } else {
      if (winData.scrollTop > nodeData.offsetTop - triggerDistance && stateSticky) {
        return ok.call(self);
      }
    }
  ...
  _proto.renderContainer = function renderContainer() {
    ...
    return _react.default.createElement("div", {
      ref: function ref(inst) {
        if (inst) _this5.stickyContainer = inst;
      },
