...
function (_Component) {
  ...
  _proto.cancelEvents = function cancelEvents() {
    ...
    if (this.StickyRef.current) {
      this.StickyRef.current.removeEventListener('DOMSubtreeModified', this.onScrollHandler(this), false);
    }
  };
  ...
  _proto.registerEvents = function registerEvents() {
    ...
    if (this.StickyRef.current) {
      this.StickyRef.current.addEventListener('DOMSubtreeModified', this.onScrollHandler(this), false);
    }
  };
  ...
  _proto.renderContainer = function renderContainer() {
    ...
    return _react.default.createElement("div", {
      ref: this.StickyRef,
      className: (0, _classnames.default)('sticky-container', className),
